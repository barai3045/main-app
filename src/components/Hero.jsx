                    ...
                    <div className="container mx-auto px-4">
                        <div className="flex flex-wrap -mx-4">
                            <div className='w-full lg:w-1/2 px-4 mb-12 lg:mb-0 flex items-center'>
                                <div className="w-full text-center lg:text-left">
                                    ...
                                    <div className="max-w-sm mx-auto lg:mx-0">
                                        ...
                                        <div>
                                            <Link  className="inline-block mb-3 lg:mb-0 lg:mr-3 w-full lg:w-auto py-2 px-6" href=""> Get Started </Link>
                                            <Link  className="inline-block w-full lg:w-auto py-2 px-6" href=""> How it works </Link>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="w-full lg:w-1/2 px-4">
                                ...
                                <div className="flex flex-wrap lg:mb-4 lg:ml-6">
                                    <img className="w-full md:w-1/2 lg:w-1/3 h-64 p-2 object-cover rounded-4xl lg:rounded-br-none" src={data['image3']} alt=''/>
                                    <img className="w-full md:w-1/2 lg:w-1/3 h-64 p-2 object-cover rounded-4xl lg:rounded-br-none" src={data['image4']} alt=''/>
                                </div>
